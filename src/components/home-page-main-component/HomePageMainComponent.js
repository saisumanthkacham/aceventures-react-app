...
import amuraImg from "../../images/amura-banner.png"
        ...
        <div className="home-page-main-component-container">
            <div className="home-page-main-content-container">
                ...
                <div className="home-page-main-description">
                    Awsome 2BHK Smart Homes.<span className="secoundary-highlight">Starting@ 42.75 Laks Only/-</span> Near infosys Pocharam.
                </div>
               <button className="secoundary-btn">Read More
