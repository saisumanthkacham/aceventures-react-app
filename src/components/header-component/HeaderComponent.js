...
return(
    ...
    <FontAwesomeIcon icon={faPhone} className="header-icon-phone header-right-icon"></FontAwesomeIcon>
    <FontAwesomeIcon icon={faBars} className="header-right-icon"></FontAwesomeIcon>
       </div>
